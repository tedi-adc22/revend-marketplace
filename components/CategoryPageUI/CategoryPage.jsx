          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-1 cursor-pointer">
              ...
              <Popover>
                <PopoverTrigger
                  type="button"
                  className="flex items-center gap-1 cursor-pointer font-bold text-gray-900 text-xs focus:outline-none select-none"
                >
                  <svg
                    className="w-4 h-4 text-gray-500 shrink-0"
                    fill="none"
                  ...
                  <svg
                    className="w-3 h-3 text-gray-400 shrink-0 ml-0.5"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <PopoverContent
                  align="end"
                  className="w-48 p-1.5 bg-white rounded-xl shadow-lg border border-gray-100 space-y-0.5"
                >
                  {SORT_OPTIONS.map((option) => {
                    ...
                    return (
                      <button
                        key={option.value}
                        onClick={() => updateUrlParams({ sort: option.value })}
