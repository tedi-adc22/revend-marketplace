  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 pb-16 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 space-y-4 sm:space-y-6">
        ...
        {/* FILTERS BAR: Horizontal scroll on small phones */}
        <div className="flex items-center gap-2 sm:gap-3 py-3 border-y border-gray-200 overflow-x-auto no-scrollbar whitespace-nowrap">
          ...
          <select
            ...
            className="shrink-0 px-3 sm:px-4 py-2 bg-white hover:bg-gray-100 border border-gray-200/80 rounded-xl text-xs font-semibold text-gray-700 shadow-sm transition-colors cursor-pointer focus:outline-none"
          >
              ...
              return (
                ...
                >
                  {viewMode === "list" ? (
                    <div className="flex flex-col sm:flex-row items-stretch">
                      ...
                      <div className="sm:w-1/2 p-3 sm:p-4 flex gap-3 sm:gap-4 border-b sm:border-b-0 sm:border-r border-gray-100">
                        ...
                        <div className="flex flex-col justify-between py-0.5 min-w-0 flex-1">
                          <div>
                            <h3 className="text-xs sm:text-sm font-bold text-gray-900 group-hover:text-orange-500 transition-colors line-clamp-1">
                              {item.title}
                            </h3>
                            <p className="text-base sm:text-xl font-black text-gray-900 mt-0.5 sm:mt-1">
                          ...
                          <div className="space-y-0.5 sm:space-y-1">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 text-[11px] sm:text-xs text-gray-400">
                              ...
                              {viewCount > 0 && (
                                <span className="hidden sm:block flex items-center gap-1 text-gray-500 font-medium">
                                  <svg
                      ...
                      <div className="sm:w-1/2 p-3 sm:p-4 flex flex-col justify-between bg-gray-50/40">
                        <div>
                          <div className="flex items-center justify-between mb-1 sm:mb-2">
                            ...
                            {item.condition && (
                              <span className="px-2 py-0.5 bg-emerald-50 text-emerald-700 text-[10px] sm:text-[11px] font-bold rounded-full border border-emerald-200/60">
                                {item.condition}
                              </span>
                            )}
                          </div>
                    ...
                    /* GRID VIEW (2 cols on mobile, 5 on desktop) */
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between border-t border-gray-200 pt-4 sm:pt-6 mt-6 sm:mt-8">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              {/* Page numbers shown on tablet/desktop only to avoid mobile wrapping */}
